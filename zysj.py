...
class CrawlerZYSJ(ShowStatus):

    def __init__(self):
        super(CrawlerZYSJ, self).__init__(SITE_NAME)
        self.treeIndex = 1
        self.headers = {
    ...
    def getPageIndexUrl(self, url):
        ...
        pageUrlList = [f"http://www.zysj.com.cn{url}" for url in html.xpath("//dd[@class='py']/a/@href")]
        # print(pageUrlList)
        return pageUrlList
    ...
    def indexPage(self, feature):
        ...
        urlList = ["http://www.zysj.com.cn"+i for i in html.xpath("//*[@id='tab-content']//a/@href")]
